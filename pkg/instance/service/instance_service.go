...
import (
	...
	event_types "whatsgo/pkg/internal/event_types"
...
func (i instances) GetInstanceByName(name string) (*instance_model.Instance, error) {
	return i.instanceRepository.GetInstanceByName(name)
}
